<?php
class autonomy extends CI_Controller
{
    public $i=0,$j=0;
  public $back;//
...
public function detail($value, $row)
    ...
    $this->load->view('adminsam1',$result);
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy <br>'.$Department.' </center><br><br>Publication of Research Articles in Journals by Staff</h3>';     
        $crud->unset_add();
...
if ($state == 'export' || $state == 'print') {
    ...
    $this->load->view('adminsam1',$result);
        ...
        $crud->columns('Student_ID','Class','Student_Name','Date','Period',"Organizer");
        $crud->callback_column('S.No',array($this,'increment'));
...
$crud->display_as('From_Date','Date');
    ...
    $this->load->view('adminsam1',$result);
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br>'.$Department.' </center><br><br>Details of Prizes won by Student in various Competition</h3>';
        $output=$crud->render();
        $this->load->view('autonomy');
           $this->load->view('table',$output);
    }
