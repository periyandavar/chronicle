...
$crud->unset_delete();
        ...
        $crud->columns('Department','Staff_Name','Designation','Qualification','Year_of_Experience','Area_of_Interest');
...
$_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Faculty Profile</h3>';
...
$crud->unset_delete();
    if($Department=='')
    redirect('select_ctrl/header');
        $crud->columns('Department','Staff_Name','Title_of_Paper','Level','Name_of_Journal','Impact_Factor','Indexed','Year_Date');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Paper Publication</h3>';
	...
	public function guest_lecture()
    {
        ...
        $crud->columns('Department','Date','Staff_Name','Title','Place');
        $crud->display_as('Name of Staff','Staff_Name');
        $crud->display_as('Venue','Forum');
        $crud->unset_add();
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Guest Lecture Deleivered</h3>';    
...
$crud->unset_delete();
    ...
    public function seminar()
    {
        ...
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit  <br> </center><br><br>Papers Presented by Staff</h3>';    
...
$crud->unset_delete();
    ...
    redirect('select_ctrl/header');
        ...
        $crud->columns('Department','Date','Staff_Name','Title_of_Paper','Level','Place','From_Date');
    ...
    public function seminar1()
    {
        ...
        //$this->output->enable_profiler(TRUE);
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit  <br> </center><br><br>Seminars/Workshops Attended by Staff</h3>';    
...
$crud->unset_delete();
    ...
    redirect('select_ctrl/header');
        ...
        //$crud->where('Event_Name','Paper Presented');
        $crud->set_subject('Seminar/Workshop');
        $crud->columns('Department','Date','Staff_Name','Event','Title_of_Program','Level','Place','From_Date');
        //$crud->fields('Date','Staff_Name','Title','Level','Place');
       //$result['data']=$this->Custom_grocery_crud_model->date($Department);
       /* $crud->display_as('Title','Title of Paper');
        $crud->display_as('Staff_Name','Name of Staff member');
     ...
     public function Awards()
    {
        ...
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit  <br> </center><br><br>Awards Received by Staff</h3>';    
...
$crud->unset_delete();
    ...
    redirect('select_ctrl/header');
        ...
        // $crud->where('Name_of_Award','Best Paper Presentation Award');
         $crud->columns('Department','Staff_Name','Nature_of_Award','Place','Date');  
         $crud->display_as('Place','Awarding Agency');
         $crud->where('Nature_of_Award!="no"');
         $crud->where('Nature_of_Award!=""');
        //$crud->where('Nature_of_Award','Awards');
        $crud->display_as('Staff_Name','Name of Staff member');
     ...
     public function Audio()
    {
        ...
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>E-content Prepared by Staff</h3>';    
...
$crud->unset_delete();
    ...
    redirect('select_ctrl/header');;
       ...
       $crud->columns('Department','Date','Staff_Name','Title_of_Program','Organising_Agency');
    ...
    public function FDP()
    {
        ...
        //$crud->where('Status','Approved');
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>FDP</h3>';    
...
$crud->unset_delete();
    ...
    redirect('select_ctrl/header');
        ...
        $crud->columns('Department','From_Date','Staff_Name','Title_of_Program','Organizing_Agency');
        $crud->display_as('Title_of_Program','Title of Program');
$crud->display_as('From_Date','Date');
    ...
    public function book()
    {
        ...
        $crud->unset_delete();
        $crud->unset_read();
        $crud->columns('Department','Staff_ID','Staff_Name','Title_of_book','Issn_isbn_for_proceeding','Year_of_publishing');
        $result['title']="<html><h2><center>Faculty Data (Audit) - <b> Books Published </b></h2></html>";
$this->load->view('admin_nav',$result);
$_SESSION['CustomTitle']='<br><h3> <center>Academic Audit  <br> </center><br><br>Books Published</h3>';
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->display_as('Staff_Name','Staff Name');
        $crud->unset_add();
        $crud->columns('Department','Title_of_Paper','Title_of_Program','ISSN','From_Date');
...
$crud->display_as('From_Date','Date');
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy <br> </center><br><br> Proceedings</h3>';
        $this->load->view('facultyreport');
        $output=$crud->render();
        $this->load->view('showtable',$output);
    }
public function ag($v,$row)
{
    ...
    function Consultancy(){
       ...
       //  $crud->set_title('Paper Publication');
        ...
        redirect('select_ctrl/header');
        $crud->field_type("Department",'hidden',$Department);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit  <br> </center><br><br>Consultancy</h3>';
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $crud->unset_add();
...
$this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Name_of_Project','Agency_Address','Date');
...
function Cluster(){
        ...
        $state = $crud->getState();
        if ($state == 'export' || $state == 'print') {
            $crud->columns('Deprtment','Staff_Name','Department','Title');
        }
        else{
            $crud->columns('Department','Date','Staff_Name','Department','Title');
        }
       //  $crud->set_title('Paper Publication');
       ...
       redirect('select_ctrl/header');
       $crud->field_type("Department",'hidden',$Department);
       $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Cluster Meetings (Cluster of Departments)</h3>';
       $result['data']=$this->selection_model->disp1($Staff_ID);
       $crud->unset_add();
       $crud->unset_edit();
       $crud->unset_delete();
...
$this->load->view('admin_nav',$result);
    ...
    function Cluster1(){
       ...
       redirect('select_ctrl/header');
       $crud->field_type("Department",'hidden',$Department);
       $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Cluster Meetings (Cluster of Colleges)</h3>';
       $result['data']=$this->selection_model->disp1($Staff_ID);
       $crud->unset_add();
       $crud->unset_edit();
       $crud->unset_delete();
...
$this->load->view('admin_nav',$result);
        ...
        //$crud->where('Status','Approved');
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Research Guidance</h3>';     
...
$crud->unset_delete();
    ...
    redirect('select_ctrl/header');
         ...
         $crud->columns('Department','Staff_Name','Guidance','Completed','Under_Guidance','Year');
...
$crud->required_fields('Staff_ID','Staff_Name','Duration_of_project','Name_of_Project','Amount_fund_received','Name_of_fundingagency','Year_of_sanction','Certificate');
    ...
    redirect('select_ctrl/header');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Research Project Received</h3>';     
        $output=$crud->render();
        $this->load->view('facultyreport');
...
public function tg($v,$row)
{
 ...
 $this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Date','Nature_of_Activity','Venue','Target_Group');
        $crud->display_as('Name_of_Program','Nature of Activity');
        $crud->display_as('Purpose','Target Group');
        
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Extension Activities</h3>';     
        $output=$crud->render();
 ...
 $this->load->view('admin_nav',$result);
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Field Visit</h3>';     
        $output=$crud->render();
...
$this->load->view('admin_nav',$result);
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>MoU Signed</h3>';     
        $state=$crud->getState();
        if ($state == 'export' || $state == 'print') {
            $crud->unset_columns('Date');
        }
 ...
 $this->load->view('admin_nav',$result);
       ...
       $crud->columns('Department','Date','Detail_of_Alumni','Type_of_Program');
       $crud->display_as('Detail of Alumini','Detail_of_Alumini');
       $crud->display_as('Type_of_Program','Type of Programme Organized');
       $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Alumni Interactions</h3>';     
       $output=$crud->render();
...
public function specialprg()
    {
        ...
        $crud->columns('Department','Type_of_Program','Title_of_Course','Strength','Date');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Certificate/Diploma/Crash Course</h3>';
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $crud->unset_add();
        $crud->unset_edit();
        $crud->unset_delete();
...
public function prg($v,$row)
{
    ...
    public function Dept()
    {
       ...
       $state = $crud->getState();
        if ($state == 'export' || $state == 'print') {
            $crud->columns('Department','Date','Nature_of_program','Level','Source_of_Funding','Amount');    
        }
        else{
            $crud->columns('Department','Date','Nature_of_program','Level','Source_of_Funding','Amount');    
        }
 ...
 $this->load->view('admin_nav',$result);
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Department Organised Events</h3>';     
    ...
    public function strength()
    {
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Stength Weakness Program</h3>';     
        //$crud->set_theme('datatables');
        //$crud->set_subject('');
 ...
 $this->load->view('admin_nav',$result);
    ...
    public function New_teaching_methods()
    {
       ...
       $crud->set_field_upload('Report','assets/uploads/files/NewTeaching');
        ...
        //$crud->unset_delete();
        //$crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>New Teaching Method Adapted</h3>';     
...
public function overall_result()
    {
        ...
        $crud->field_type('Department','hidden',$Department);
        $output=$crud->render();
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Overall Results</h3>';     
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $crud->unset_add();
        $crud->unset_edit();
        $crud->unset_delete();
...
$crud->unset_delete();
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Student Progression</h3>';     
        $crud->required_fields('Trends_of_progression','No_of_students','percentage','Batch');
        $crud->field_type('Department','hidden',$Department);
        $crud->columns('Department','Trends_of_progression','No_of_students','percentage','Batch');
        $output=$crud->render();
        $result['data']=$this->selection_model->disp1($Staff_ID);
        // $crud->unset_add();
        // $crud->unset_edit();
...
$crud->unset_delete();
        ...
        $crud->field_type('Department','hidden',$Department);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Student Dropouts</h3>';     
...
$crud->where('Place_Prize!=""');
        ...
        //$crud->unset_print();
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Academic Awards by Students</h3>';             
    ...
    public function competitive_exam()
    {
        ...
        $crud->set_table('student_info');
        $Staff_ID=$this->session->userdata('Staff_ID');
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Competitive Exams</h3>';     
        $result['data']=$this->selection_model->disp1($Staff_ID);
...
$crud->unset_delete();
        ...
        $crud->columns('Department','Student_Name','Class','Competitive_Exam_Passed','year');
...
$result['data']=$this->selection_model->disp1($Staff_ID);
$_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Cultural Awards by Students</h3>';     
...
public function lvl($v,$row)
{
    ...
    public function sports()
    {
        ...
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Students Achievements in Sports </h3>';                 
...
$crud->where('Event_Type','Sports and Games');
        $crud->columns('Department','Student_Name','Class','Title_of_Event','Level','Date');
        //$crud->set_relation('Event_Type','student_info','{Event_Type}','{Level}');
        $state=$crud->getState();
        if ($state == 'export' || $state == 'print') {
            $crud->unset_columns('Date');
...
$output=$crud->render();
     ...
     public function stud()
    {
        ...
        $crud->unset_add();
        // $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center><br> </center><br><br>Students Profile</h3>';     
...
$this->load->view('admin_nav',$result);
     ...
     public function overall_shield()
    {
        ...
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $crud->unset_add();
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Overall Shields received</h3>';     
        $crud->unset_edit();
        $crud->unset_delete();
        $crud->unset_read();
        $output=$crud->render();
...
public function ppp()
{
    ...
    public function internship()
    {
        ...
        $crud->columns('Department','Student_ID','Student_Name','Date','To_Date','Department','Title_of_Event','Organizer');
        ...
        $crud->display_as('Organizer','Venue');
         ...
         $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Internship Training Program</h3>';     
        $result['data']=$this->selection_model->disp1($Staff_ID);
         $crud->unset_add();
         $crud->unset_edit();
         $crud->unset_delete();
 ...
 $this->load->view('deptrpt');
    ...
    public function peer_learning()
    {
        ...
        $crud->columns('Department','Student_Name','Class','Title_of_Event','beneficiary','venue','Date');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Peer Learning</h3>';     
 ...
 $this->load->view('admin_nav',$result);
	...
	public function training()
    {
        ...
        $crud->columns('Department','Student_Name','Event_Type','Title_of_Event','Date','To_Date','time');
        $crud->display_as('Date','From_Date');
		$_SESSION['CustomTitle']='<br><h3> <center>Academic Audit <br> </center><br><br>Summer Trainning</h3>';     
        $result['data']=$this->selection_model->disp1($Staff_ID);
        $crud->unset_add();
         $crud->unset_edit();
         $crud->unset_delete();
