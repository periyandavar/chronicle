<?php
class stud_appraisal1 extends CI_Controller
{  
     ...
     public function AnnexureVIII()
    {
       ...
       //$crud->where('Title_of_Event','Quiz'or 'conference');
        ...
        $crud->unset_read();
        $crud->unset_edit();
        $crud->columns('Department','Student_Name','Title_of_Event','Organizer','Place_Prize','Date');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Appraisal <br> </center><br><br>Student Performance</h3>';
 ...
 $this->load->view('admin_nav',$result);
     ...
     public function AnnexureIX()
    {
        ...
        //$crud->unset_add();
        //$crud->unset_edit();
        $crud->columns('Department','Student_ID','Student_Name','Class','Title_of_program','Organizer','Date','Indexed');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Appraisal <br> </center><br><br>Student Publications </h3>';
        $output=$crud->render();
        $result['data']=$this->selection_model->disp1($Staff_ID);
   ...
   public function AnnexureX()
    {
        ...
        $crud->unset_delete();
        $crud->unset_edit();
        $crud->columns('Department','Student_Name','Title_of_Paper','Occasion in which Presented/Published','Date');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Appraisal <br> </center><br><br>Students Presented </h3>';
        $state=$crud->getState();
        if ($state == 'export' || $state == 'print') {
            $crud->unset_columns('Date');
        }
...
$this->load->view('Appraisal1');
    ...
    public function AnnexureXI()
    {
        ...
        //$crud->unset_add();
        //$crud->unset_edit();
        $crud->columns('Department','Student_Name','Student_ID','Class','Award','Organizer','Date');
       ...
       $crud->set_field_upload('Evidence3','assets/uploads/files/project');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Appraisal <br> </center><br><br>Best Paper Awards by Students</h3>';
        $output=$crud->render();
        $result['data']=$this->selection_model->disp1($Staff_ID);
  ...
  public function AnnexureXVII()
    {
        ...
        $crud->unset_print();
        $crud->unset_export();
        $crud->columns('Department','Student_Name','Title_of_Event','Organizer','beneficiary','venue');
        $crud->display_as('Student_Name','Name of the Students');
        $crud->display_as('Title_of_Event','Title of the Event');
