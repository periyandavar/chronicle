 ...
 <html>  
      ...
      <body>  
        <?php include ('sidepush.php') ?>
           <center><h4>Book Published</h4></center>
            
           <div class="container" style="width:500px;">  
                 <?php echo form_open_multipart('extension_ctrl/do_upload');?>
                  ...
                  <input type="text" name="Department" value="<?php foreach($data as $row) echo "$row->Department"?>"   class="form-control"><br>
                     ...
                     <br />  
                     <label>Title of Book Published</label>  
                     ...
                     <br />  
                     <label>Name of Proceeding Conference</label>  
