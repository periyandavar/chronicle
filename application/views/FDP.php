<!DOCTYPE html>  
 <html>  
      ...
      <body>  
           ...
           <center><h4>Faculty Development Programmes </h4></center>
            
           <div class="container" style="width:500px;">  
                 <?php echo form_open_multipart('FDP/get_user');?>
                  ...
                  <input type="text" name="Department" value="<?php foreach($data as $row) echo "$row->Department"?>"   class="form-control"><br>
                     <label>Title_of_Program</label>  
                     <textarea name="Title_of_Program" id="Title_of_Program" class="form-control" required>  </textarea>
                     <br />  
                       
                     <label>Organizing Agency</label>  
                     <input type="text" name="Organizing_Agency" id="Organizing_Agency" class="form-control" required /> 
                     <br /> 
                     
                     <label>Date</label>  <label>From</label>
                     <input type="Date" placeholder="YYYY-MM-DD"  
pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"  name="From_Date" class="form-control" required>
<label>To</label>
<input type="Date" placeholder="YYYY-MM-DD"  
pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"  name="To_Date" class="form-control" required>
<br>
