...
<form method="post" action='change_pass'>
		...
		<input type="password" name="Password" id="name" reqired placeholder="Old Pass" class="form-control"/><br /><br />
		
		<input type="password" name="New_Password" id="password" reqired placeholder="New Password" class="form-control"/><br/><br />
