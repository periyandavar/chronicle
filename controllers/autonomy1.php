<?php
class autonomy1 extends CI_Controller
{
    public $i=0,$j=0;
  public $back;//
...
public function detail($value, $row)
        {                       
            $str=$row->Name_of_Journal.', '.$row->Page_No.', '.$row->ISSN_ISBN.', '.$row->Indexed.', '.date('d-m-Y', strtotime($row->Year_Date));//$date=new DateTime($row->Year_Date),'d/m/Y');
            return $str;
        }
    ...
    $result['data']=$this->selection_model->disp1($Staff_ID);
    $result['title']="<html><h2><center><b>Papers in Journals (Staff)</b></h2></html>";
    $this->load->view('admin_nav',$result);
           $crud->set_table('paper_publication');
        $crud->columns('Department','Staff_Name','Title_of_Paper','Name_of_Journal','Year_Date','Indexed','Journals','ISSN_ISBN','Page_No');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>Publication of Research Articles in Journals by Staff</h3>';     
        $crud->unset_add();
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Staff_Name','To_Date','Title_of_Paper','Occasion in which Presented/Published','Event','Title_of_Program','Place','From_Date','Level');
        $crud->callback_column('S.No',array($this,'increment'));
...
if ($state == 'export' || $state == 'print') {
  ...
  $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>Paper Presentation in Seminars,Symposia and Conferences by Staff </h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
        $this->load->view('showtable',$output);
    }
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Date','Nature of Extension activity carried out','Objective','Impact','No_of_Participants');
        
        $crud->unset_add();
        $crud->unset_delete();
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br> Details of Extension Activities Carried out</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
        $this->load->view('showtable',$output);
    }
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Date','Name_of_Speaker','Nature_of_program');
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br> Details of Guest Lectures conducted</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
        $this->load->view('showtable',$output);
    }
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br> Seminars / Symposia /Workshop Organized</h3>';
        $state=$crud->getState();
        if ($state == 'export' || $state == 'print') {
...
$crud->unset_delete();
$crud->unset_read();
$_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant <br> </center><br><br>Best Paper Awards by Staffs</h3>';
$result['title']= "<html><h2><center><b>Best Paper Awards by Staffs</b></h2></html>";
    ...
    public function awardsst()
    {
       ...
       $crud->set_field_upload('Evidence3','assets/uploads/files/project');
        ...
        $crud->set_field_upload('Certificate','assets/uploads/files/Seminar');
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant <br> </center><br><br>Best Paper Awards by Students</h3>';
        $output=$crud->render();
        $result['data']=$this->selection_model->disp1($Staff_ID);
...
$this->load->view('autonomy1');
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->set_subject('Seminar/Workshop');
        $crud->columns('Department','Staff_Name','Date',"Details",'From_Date','To_Date','Event','Title','Place');
        $crud->callback_column('S.No',array($this,'increment'));
        //$crud->fields('Date','Staff_Name','Title','Level','Place');
        $crud->display_as('Staff_Name','Name of Staff member');
        $crud->set_field_upload('Certificate','assets/uploads/files/Seminar');
        $crud->unset_columns('Department','To_Date','Event','Title','Place','Staff_Name');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br> Participated in Seminars, Symposia and Conferences (No Paper Presentation) by the staffs</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Class','Date1',"Institude_Address",'Knowledge_gained','Date');
        $crud->callback_column('S.No',array($this,'increment'));
        //$crud->fields('Date','Staff_Name','Title','Level','Place');
        $crud->display_as('Date1','Date');
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br> Details of Study tour/ Factory visit Organized</h3>';
        $state = $crud->getState();
if ($state == 'export' || $state == 'print') {
    $crud->unset_columns('Date');
}
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Student_ID','Class','Student_Name','Date','Period',"Organizer");
        $crud->callback_column('S.No',array($this,'increment'));
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>The Students who have undergoes Summer training and Project Work in the reputed Organizations/Insitutions/Universities</h3>';
        $state = $crud->getState();
if ($state == 'export' || $state == 'print') {
    $crud->unset_columns('Date');
} else {
 ...
 public function books()
    {
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>Books Published by Staff</h3>';
    $result['data']=$this->selection_model->disp1($Staff_ID);
    $result['title']="<html><h2><center><b>Books Published by Staff</b></h2></html>";
    $this->load->view('admin_nav',$result);
        $crud->set_table('book');
        //$_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>10) Books Published</h3>';
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->display_as('Staff_Name','Staff Name');
        $crud->unset_add();
        $crud->columns('Department','Title_of_Paper','Title_of_Program','ISSN','From_Date','Date');
        $crud->callback_column('Date',array($this,'pp3'));
...
$crud->display_as('From_Date','Date');
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br> Proceedings</h3>';
        $this->load->view('autonomy1');
        $state = $crud->getState();
if ($state == 'export' || $state == 'print') {
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Student_Name','Title_of_Paper','Occasion in which Presented/Published','Event_Type','Level','Title_of_Event','Title_of_program','Organizer','Date');
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br> Paper Presetation in Seminars, Symposia Conference by students</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
    ...
    $result['data']=$this->selection_model->disp1($Staff_ID);
    $result['title']="<html><h2><center><b>Seminars/Conferences Participated by Students (No Paper Presentation)</b></h2></html>";
    $this->load->view('admin_nav',$result);
        $crud->set_table('student_info');
        ...
        if($state == 'print')
    {
        ...
        $crud->columns('Department','Student_Name','Title_of_Paper','From_Date','To_Date','Details','Level','Title_of_Event','Title_of_program','Organizer','Date');
        //$crud->display_as('Student_Name','Author(s)');
$crud->display_as('From_Date','Date');
        $crud->display_as('Title_of_Paper','Title of the Paper');
        ...
        if ($state == 'export' || $state == 'print') {
            ...
            $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br> Participated in Seminars, Symposia and Conferences (No Paper Presentation) by the student</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
           $this->load->view('table',$output);
    }
    ...
    $this->load->view('admin_nav',$result);
        ...
        //$crud->unset_export();
        $crud->columns('Department','Date','Name of the Event & Venue','Particulars of the Participant(s)','Place_Prize');
        //$crud->display_as('Student_Name','Author(s)');
        //$crud->display_as('Title_of_Paper','Title of the Paper');
        ...
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>Details of Prizes won by Student in various Competition</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
           $this->load->view('table',$output);
    }
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Date','Institute_Company','Duration','Purpose');
        $crud->unset_add();
        $crud->unset_delete();
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>MoU Signed</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
        $this->load->view('showtable',$output);
    }
   ...
   public function awards()
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->where('Nature_of_Award','Best Paper Award');
        $crud->columns('Department','Staff_Name','Awarding_Agency','Department','Date');
        $crud->display_as('Staff_Name','Name of Awardee');
        $crud->display_as('Awarding_Agency','Name of Awardee Agency with Contact Detail');
        $crud->callback_column('S.No',array($this,'increment'));
        $crud->unset_add();
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>Best Paper Presentation Award won by Student/Staff</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
        $this->load->view('showtable',$output);
    }
  ...
  public function alumni()
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->columns('Department','Detail_of_Alumni','Date','Type_of_Program');
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>Details of the interaction with Alumni</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
        $this->load->view('showtable',$output);
    }
    ...
    $this->load->view('admin_nav',$result);
        ...
        $crud->unset_edit();
        $crud->unset_read();
        $_SESSION['CustomTitle']='<br><h3> <center>Autonomy Grant<br> </center><br><br>Achievements in Inter-Collegiate Competitions</h3>';
        $output=$crud->render();
        $this->load->view('autonomy1');
        $this->load->view('showtable',$output);
    }
