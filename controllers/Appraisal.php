...
//        $crud->set_field_upload('Certificate','assets/uploads/files/Seminar');
  ...
  $_SESSION['CustomTitle']='<br><h3> <center>Department Appraisal <br>'.$Department.' </center><br><br> Paper Presented by Staff Members in Seminars/Symposium/Conferences</h3>';
  $state=$crud->getState();
        if ($state == 'export' || $state == 'print') {
