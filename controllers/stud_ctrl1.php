<?php
class stud_ctrl1 extends CI_Controller
{  
...
$crud->set_field_upload('Evidence3','assets/uploads/files/intercollegiate');
 ...
 // $crud->set_read_fields('Department','Student_ID','Student_Name','Class','Title_of_program','Level','Organizer','Date','Year','Place_Prize','Certificate','Evidence2','Evidence2','Presented');
  ...
  $crud->where('Department',$Department);
        $crud->where('Event_Type',"Workshops");
        ...
        //$crud->unset_print();
        $_SESSION['CustomTitle']='<br><h3> <center>'.$Department.' </center><br><br> Workshop Attended by Students</h3>';     
        //$crud->unset_export();
